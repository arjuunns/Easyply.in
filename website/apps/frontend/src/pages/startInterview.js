...
export default function InterviewPage() {
    ...
    return (_jsxs("div", { className: "h-screen bg-gray-900 flex flex-col overflow-hidden", children: [_jsx("div", { className: "bg-gray-800 border-b border-gray-700 px-6 py-3", children: _jsx(TopPanel, { timeElapsed: timeElapsed, setShowChat: setShowChat, showChat: showChat }) }), _jsxs("div", { className: "flex-1 flex overflow-hidden", children: [_jsx(LeftPanel, {}), _jsx(RightPanel, { currentQ: currentQ }), _jsx(AnimatePresence, { children: showChat && (_jsx(motion.div, { initial: { width: 0, opacity: 0 }, animate: { width: 320, opacity: 1 }, exit: { width: 0, opacity: 0 }, transition: { duration: 0.3 }, className: "bg-gray-800 border-l border-gray-700 overflow-hidden", children: _jsx(ChatPanel, {}) })) })] })] }));
}
